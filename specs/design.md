...
The scratchpad walk does not go through this parser (bullets carry HTML-comment provenance, not YAML), so it strips independently at `parseObservationsFromScratchpad` — same rule, different reader.
