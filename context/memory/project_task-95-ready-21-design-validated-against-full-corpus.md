...
type: project
shape: State
title: Task 95 Ready – §21 Design Validated Against Full Corpus
...
**How to apply:** Proceed with Task 95 implementation using the contract as-is. Design validation clears the path to implementation.
