...
type: project
shape: State
title: Obsidian Vault Setup for Memory Kit
...
**How to apply:** When exploring memory visually in Obsidian, open context/memory/ as dedicated vault; direct edits to fact files outside Obsidian
