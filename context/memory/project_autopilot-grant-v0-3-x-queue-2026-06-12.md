...
id: P-CZ7WMRYM
type: project
title: autopilot grant — v0.3.x queue (2026-06-12)
created_at: 2026-06-12T15:17:54Z
...
**How to apply:** Within the queue: implement → tests → reviews → fix → merge → housekeeping → next task, no per-task confirmation. Outside the queue: confirm scope first.
